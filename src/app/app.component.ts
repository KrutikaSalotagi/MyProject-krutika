...
import { StruturalDirComponent } from './directive/strutural-dir/strutural-dir.component';


@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet,  ReactiveFormsModule, DataBindingComponent,StruturalDirComponent],
